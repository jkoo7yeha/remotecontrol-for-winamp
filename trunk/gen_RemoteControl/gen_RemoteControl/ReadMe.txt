========================================================================
    ANWENDUNG: gen_RemoteControl-Projektübersicht
========================================================================

Diese gen_RemoteControl-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre gen_RemoteControl-Anwendung besteht.

gen_RemoteControl.vcxproj
...
gen_RemoteControl.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "gen_RemoteControl.pch und eine 
